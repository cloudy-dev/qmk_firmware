...
[1] = LAYOUT_65_ansi(
   ...
   _______,_______,  KC_UP,X(EURO_SIGN),_______,_______,_______,XP(UE_SMALL, UE_BIG),KC_PSCR,XP(OE_SMALL, OE_BIG),KC_PAUS,  KC_UP,_______,     _______,_______,
   _______,XP(AE_SMALL, AE_BIG),X(SZ_SMALL),KC_RGHT,_______,_______,_______,_______,KC_HOME,KC_PGUP,KC_LEFT,KC_RGHT,            _______,_______,
